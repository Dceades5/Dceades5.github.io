(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(400, 570, 0.75, 0.5);
        platform.create(700, 700, 0.75, 0.5);
        platform.create(75, 470, 0.75, 0.5);
        platform.create(300, 375, 0.75, 0.5);
        platform.create(75, 275, 0.75, 0.5)
        platform.create(55, 55, 0.75, 0.5)
